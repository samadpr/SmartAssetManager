...
namespace SAMS.Migrations
{
    ...
    [Migration("20251227052451_EmployeeChangeToUser")]
    partial class EmployeeChangeToUser
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SAMS.Models.Asset", b =>
                {
                    ...
                    b.Property<long?>("AssignEmployeeUserProfileId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("AssignEmployeeUserProfileId");
            ...
            modelBuilder.Entity("SAMS.Models.Asset", b =>
                {
                    ...
                    b.HasOne("SAMS.Models.UserProfile", "AssignEmployee")
                        .WithMany("Assets")
                        .HasForeignKey("AssignEmployeeUserProfileId");
