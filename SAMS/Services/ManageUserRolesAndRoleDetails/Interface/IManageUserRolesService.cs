...
namespace SAMS.Services.ManageUserRoles.Interface
{
    public interface IManageUserRolesService
    {
        ...
        Task<ManageUserRole> GetUserRoleByIdAsync(int id);

        Task<ManageUserRolesDetail> GetUserRoleDetailsByIdAsync(int id);

        Task<IEnumerable<ManageUserRolesDetail>> GetRoleDetailsByManagedRoleIdAsync(long roleId);
